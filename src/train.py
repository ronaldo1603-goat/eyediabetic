...
def main():
    ...
    # data loading code
    # Use images directly from inputs/ folders (no preprocessing to processed/ folder)
    if 'diabetic_retinopathy' in args.train_dataset:
        ...
        diabetic_retinopathy_img_paths = \
            'inputs/diabetic-retinopathy-resized/resized_train/' + diabetic_retinopathy_df['image'].values + '.jpeg'
    ...
    if 'aptos2019' in args.train_dataset:
        ...
        # Use images directly from inputs/train_images/ (preprocessing will be done on-the-fly in Dataset)
        aptos2019_img_paths = 'inputs/train_images/' + aptos2019_df['id_code'].values + '.png'
    ...
    if args.pseudo_labels:
        ...
        # Use images directly from inputs/test_images/ (preprocessing will be done on-the-fly)
        test_img_paths = 'inputs/test_images/' + test_df['id_code'].values + '.png'
    ...
    if 'messidor' in args.train_dataset:
        # Messidor uses glob pattern, no preprocessing needed
        pass
    ...
    for fold, ((train_img_paths, val_img_paths), (train_labels, val_labels)) in enumerate(zip(img_paths, labels)):
        ...
        if args.remove_duplicate:
            ...
            duplicate_img_paths = 'inputs/train_images/' + md5_df[(md5_df.strMd5_count > 1) & (~md5_df.diagnosis.isnull())]['id_code'].values + '.png'
        ...
        train_set = Dataset(
            ...
            scale_radius_enabled=args.scale_radius,
        ...
        if args.class_aware:
            ...
            #     num_samples=11000,
            #     replacement=False)
            pass  # Implement class_aware sampler if needed
